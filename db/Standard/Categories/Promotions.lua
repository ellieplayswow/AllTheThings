...
p(4616,{awp=110002,b=1,description="Trolli + Xbox promotional item. Available between 9/1/24 - 2/28/25 by purchasing Trolli Candy products in any retail store, photoing your receipt and uploading it as confirmation to trolli.com/xbox. Once processed, you should receive a code to your email to redeem on battle.net or in the launcher.\n\nYou must have a U.S. address and phone number to participate.\n\nThe code is usable in any region.",itemID=228765,npcID=229860,rwp=110100,spellID=463148,u=2}),
s(224731,228761,{awp=110002,description="Trolli + Xbox promotional item. Available between 9/1/24 - 2/28/25 by purchasing Trolli Candy products in |CFFFF0000Walgreens|r, photoing your receipt and uploading it as confirmation to trolli.com/xbox. Once processed, you should receive a code to your email to redeem on battle.net or in the launcher.\n\nYou must have a U.S. address and phone number to participate.\n\nThe code is usable in any region.",f=9,rwp=110100,u=2}),
s(224733,228763,{awp=110002,description="Trolli + Xbox promotional item. Available between 9/1/24 - 2/28/25 by purchasing Trolli Candy products in |CFFFF0000Circle K|r, photoing your receipt and uploading it as confirmation to trolli.com/xbox. Once processed, you should receive a code to your email to redeem on battle.net or in the launcher.\n\nYou must have a U.S. address and phone number to participate.\n\nThe code is usable in any region.",f=9,rwp=110100,u=2}),
s(224732,228762,{awp=110002,description="Trolli + Xbox promotional item. Available between 9/1/24 - 2/28/25 by purchasing Trolli Candy products in |CFFFF0000Dollar General|r, photoing your receipt and uploading it as confirmation to trolli.com/xbox. Once processed, you should receive a code to your email to redeem on battle.net or in the launcher.\n\nYou must have a U.S. address and phone number to participate.\n\nThe code is usable in any region.",f=9,rwp=110100,u=2}),
s(224734,228764,{awp=110002,description="Krogers promotional item. You have to earn points before Jan 8, 2025 and redeem before Feb 7, 2025. Can be redeemed for 1500 rewards points from pointsrewardsplus.com. With a referral link, just signing up will earn you enough points to redeem the tabard for free. Access the code from the account page and then redeem on battle.net or in the launcher.",f=9,rwp=110007,u=2}),
mnt(454682,{awp=110002,b=1,description="Obtained if you set up a 12-Month WoW Subscription.",itemID=225250,lvl=10,u=3}),
mnt(463025,{awp=110002,b=1,description="Obtained if you set up a 12-Month WoW Subscription.",itemID=228751,lvl=10,u=3}),
p(665,{awp=110005,b=1,itemID=72153,npcID=54745,spellID=102353,u=2}),
s(224993,228907,{awp=110005,description="Available to redeem for 300 points at DoritosDewRockstar.com before Jan 31, 2025. Points can be earned from entering codes found in specially marked Mountain Dew, Doritos and Rockstar Energy Drink products.",f=2,rwp=110007,u=2}),
s(224995,228909,{awp=110005,description="Available to redeem for 300 points at DoritosDewRockstar.com before Jan 31, 2025. Points can be earned from entering codes found in specially marked Mountain Dew, Doritos and Rockstar Energy Drink products.",f=9,rwp=110007,u=2}),
...
[2112]={{38.3,94.9}}},lvl=10,qgs={222277},sr=1,u=3,g={
i(220737,{sr=1,u=3}),
s(218742,220710,{f=2,sr=1,u=3}),
s(218741,220709,{f=2,sr=1,u=3}),
s(218748,220716,{f=2,sr=1,u=3}),
s(218743,220711,{f=3,sr=1,u=3}),
s(218747,220715,{f=2,sr=1,u=3}),
s(218744,220712,{f=2,sr=1,u=3}),
s(218745,220713,{f=2,sr=1,u=3}),
s(218746,220714,{f=2,sr=1,u=3}),
s(218749,220717,{f=2,sr=1,u=3}),
s(218728,220696,{f=2,sr=1,u=3}),
s(218727,220695,{f=2,sr=1,u=3}),
s(218734,220702,{f=2,sr=1,u=3}),
s(218729,220697,{f=3,sr=1,u=3}),
s(218733,220701,{f=2,sr=1,u=3}),
s(218730,220698,{f=2,sr=1,u=3}),
s(218731,220699,{f=2,sr=1,u=3}),
s(218732,220700,{f=2,sr=1,u=3}),
s(218735,220703,{f=2,sr=1,u=3}),
s(218751,220719,{f=2,sr=1,u=3}),
s(218750,220718,{f=2,sr=1,u=3}),
s(218757,220725,{f=2,sr=1,u=3}),
s(218752,220720,{f=3,sr=1,u=3}),
s(218756,220724,{f=2,sr=1,u=3}),
s(218753,220721,{f=2,sr=1,u=3}),
s(218754,220722,{f=2,sr=1,u=3}),
...
[2339]={{35.3,38.2}}},lvl=70,qgs={225347},sr=1,sym={{"select","questID",81993},{"pop"}},u=3}),
q(81994,{awp=110000,coords={
[2112]={{38.3,94.9}}},lvl=10,qgs={222277},sourceQuests={81993,83024},sr=1,u=3,g={
s(218740,220708,{f=2,sr=1,u=3}),
s(218738,220706,{f=2,sr=1,u=3}),
s(218737,220705,{f=2,sr=1,u=3}),
s(218739,220707,{f=2,sr=1,u=3}),
s(218736,220704,{f=2,sr=1,u=3}),
s(218768,220736,{f=2,sr=1,u=3}),
s(218766,220734,{f=2,sr=1,u=3}),
s(218765,220733,{f=2,sr=1,u=3}),
s(218767,220735,{f=2,sr=1,u=3}),
s(218764,220732,{f=2,sr=1,u=3}),
s(218763,220731,{f=2,sr=1,u=3}),
s(218761,220729,{f=2,sr=1,u=3}),
s(218760,220728,{f=2,sr=1,u=3}),
s(218762,220730,{f=2,sr=1,u=3}),
s(218759,220727,{f=2,sr=1,u=3})}}),
q(83025,{awp=110000,coords={
[2339]={{35.3,38.2}}},lvl=70,qgs={225347},sr=1,sym={{"select","questID",81994},{"pop"}},u=3}),
...
s(291682,242908,{c={12},e=422,f=5}),
s(291675,242901,{c={12},e=422,f=3}),
s(291683,242909,{c={12},e=422,f=5}),
s(291678,242904,{c={12},e=422,f=5}),
s(291676,242902,{c={12},e=422,f=5}),
s(291680,242906,{c={12},e=422,f=5}),
s(291677,242903,{c={12},e=422,f=5}),
s(291681,242907,{c={12},e=422,f=5}),
s(291679,242905,{c={12},e=422,f=5})}}),
en(244800,{cost={{"c",3309,40}},e=422,spellID=1237972,tmogSetID=4574,u=2,g={
s(291727,242960,{c={2},e=422,f=7}),
s(291728,242961,{c={2},e=422,f=7}),
s(291721,242954,{c={2},e=422,f=7}),
s(291720,242953,{c={2},e=422,f=3}),
s(291724,242957,{c={2},e=422,f=7}),
s(291723,242956,{c={2},e=422,f=7}),
s(292213,244447,{c={2},e=422,f=7}),
s(291725,242958,{c={2},e=422,f=7}),
s(291722,242955,{c={2},e=422,f=7}),
s(291726,242959,{c={2},e=422,f=7})}}),
en(244799,{cost={{"c",3309,40}},e=422,spellID=1237973,tmogSetID=4565,u=2,g={
s(292191,244420,{c={10},e=422,f=5}),
s(292183,244412,{c={10},e=422,f=3}),
s(292190,244419,{c={10},e=422,f=5}),
s(292186,244415,{c={10},e=422,f=5}),
s(292187,244416,{c={10},e=422,f=5}),
s(292188,244417,{c={10},e=422,f=5}),
s(292189,244418,{c={10},e=422,f=5}),
s(292185,244414,{c={10},e=422,f=5}),
s(292184,244413,{c={10},e=422,f=5})}}),
en(244798,{cost={{"c",3309,40}},e=422,spellID=1237957,tmogSetID=4570,u=2,g={
s(291717,242944,{c={8},e=422,f=4}),
s(291718,242945,{c={8},e=422,f=4}),
s(292209,244443,{c={8},e=422,f=4}),
s(291711,242938,{c={8},e=422,f=4}),
s(291719,242946,{c={8},e=422,f=3}),
s(291713,242940,{c={8},e=422,f=4}),
s(291712,242939,{c={8},e=422,f=4}),
s(291716,242943,{c={8},e=422,f=4}),
s(291714,242941,{c={8},e=422,f=4}),
s(291715,242942,{c={8},e=422,f=4})}}),
en(244805,{cost={{"c",3309,40}},e=422,spellID=1237966,tmogSetID=4564,u=2,g={
s(291671,242897,{c={1},e=422,f=7}),
s(291668,242894,{c={1},e=422,f=7}),
s(291674,242900,{c={1},e=422,f=3}),
s(291670,242896,{c={1},e=422,f=7}),
s(291666,242892,{c={1},e=422,f=7}),
s(291672,242898,{c={1},e=422,f=7}),
s(291667,242893,{c={1},e=422,f=7}),
s(291673,242899,{c={1},e=422,f=7}),
s(291669,242895,{c={1},e=422,f=7})}}),
en(244803,{cost={{"c",3309,40}},e=422,spellID=1237968,tmogSetID=4569,u=2,g={
s(292172,244400,{c={7},e=422,f=6}),
s(292173,244401,{c={7},e=422,f=6}),
s(292165,244393,{c={7},e=422,f=6}),
s(292164,244392,{c={7},e=422,f=3}),
s(292171,244399,{c={7},e=422,f=6}),
s(292167,244395,{c={7},e=422,f=6}),
s(292166,244394,{c={7},e=422,f=6}),
s(292168,244396,{c={7},e=422,f=6}),
s(292169,244397,{c={7},e=422,f=6}),
s(292170,244398,{c={7},e=422,f=6})}}),
en(244793,{cost={{"c",3309,40}},e=422,spellID=1237962,tmogSetID=4567,u=2,g={
s(291759,242993,{c={6},e=422,f=7}),
s(291758,242992,{c={6},e=422,f=3}),
s(291756,242990,{c={6},e=422,f=7}),
s(291761,242995,{c={6},e=422,f=7}),
s(291762,242996,{c={6},e=422,f=7}),
s(291763,242997,{c={6},e=422,f=7}),
s(291764,242998,{c={6},e=422,f=7}),
s(291760,242994,{c={6},e=422,f=7}),
s(291757,242991,{b=1,c={6},e=422,f=7})}}),
en(244804,{cost={{"c",3309,40}},e=422,spellID=1237967,tmogSetID=4573,u=2,g={
s(291744,242977,{c={9},e=422,f=4}),
s(292214,244448,{c={9},e=422,f=4}),
s(291738,242971,{c={9},e=422,f=4}),
s(291745,242978,{c={9},e=422,f=4}),
s(291746,242979,{c={9},e=422,f=3}),
s(291741,242974,{c={9},e=422,f=4}),
s(291743,242976,{c={9},e=422,f=4}),
s(291739,242972,{c={9},e=422,f=4}),
s(291742,242975,{c={9},e=422,f=4}),
s(291740,242973,{c={9},e=422,f=4})}}),
en(244796,{cost={{"c",3309,40}},e=422,spellID=1237959,tmogSetID=4562,u=2,g={
s(291694,242921,{c={13},e=422,f=6}),
s(291696,242923,{c={13},e=422,f=6}),
s(291693,242920,{c={13},e=422,f=3}),
s(291697,242924,{c={13},e=422,f=6}),
s(291700,242927,{c={13},e=422,f=6}),
s(291698,242925,{c={13},e=422,f=6}),
s(291699,242926,{c={13},e=422,f=6}),
s(291695,242922,{c={13},e=422,f=6}),
s(291701,242928,{c={13},e=422,f=6})}}),
en(244802,{cost={{"c",3309,40}},e=422,spellID=1237969,tmogSetID=4568,u=2,g={
s(291736,242969,{c={4},e=422,f=5}),
s(291731,242964,{c={4},e=422,f=5}),
s(291737,242970,{c={4},e=422,f=5}),
s(291730,242963,{c={4},e=422,f=5}),
s(291729,242962,{c={4},e=422,f=3}),
s(291732,242965,{c={4},e=422,f=5}),
s(291733,242966,{c={4},e=422,f=5}),
s(291734,242967,{c={4},e=422,f=5}),
s(291735,242968,{c={4},e=422,f=5})}}),
en(244795,{cost={{"c",3309,40}},e=422,spellID=1237960,tmogSetID=4571,u=2,g={
s(291691,242917,{c={11},e=422,f=5}),
s(291686,242912,{c={11},e=422,f=5}),
s(291692,242918,{c={11},e=422,f=5}),
s(291685,242911,{c={11},e=422,f=5}),
s(291684,242910,{c={11},e=422,f=3}),
s(291688,242914,{c={11},e=422,f=5}),
s(291687,242913,{c={11},e=422,f=5}),
s(291689,242915,{c={11},e=422,f=5}),
s(291690,242916,{c={11},e=422,f=5}),
s(292210,244444,{c={11},e=422,f=5})}}),
en(244797,{cost={{"c",3309,40}},e=422,spellID=1237958,tmogSetID=4563,u=2,g={
s(291709,242936,{c={3},e=422,f=6}),
s(291710,242937,{c={3},e=422,f=6}),
s(291703,242930,{c={3},e=422,f=6}),
s(291702,242929,{c={3},e=422,f=3}),
s(291705,242932,{c={3},e=422,f=6}),
s(291704,242931,{c={3},e=422,f=6}),
s(291706,242933,{c={3},e=422,f=6}),
s(291707,242934,{c={3},e=422,f=6}),
s(291708,242935,{c={3},e=422,f=6})}}),
en(244801,{cost={{"c",3309,40}},e=422,spellID=1237970,tmogSetID=4572,u=2,g={
s(292150,244377,{c={5},e=422,f=4}),
s(292151,244378,{c={5},e=422,f=4}),
s(292212,244446,{c={5},e=422,f=4}),
s(292144,244371,{c={5},e=422,f=4}),
s(292152,244379,{c={5},e=422,f=3}),
s(292146,244373,{c={5},e=422,f=4}),
s(292145,244372,{c={5},e=422,f=4}),
s(292147,244374,{c={5},e=422,f=4}),
s(292149,244376,{c={5},e=422,f=4}),
s(292148,244375,{c={5},e=422,f=4})}})}})}})}}),
...
s(194927,212607,{f=2,u=2}),
s(194958,212644,{f=2,u=2}),
...
s(105947,171327,{f=2}),
s(105945,171325,{f=2}),
s(105953,171333,{b=1,f=3}),
s(105959,171361,{b=1,f=9}),
s(105950,171330,{f=2}),
s(105946,171326,{f=2}),
s(105951,171331,{f=2})}}),
...
s(185424,204086,{awp=100007,b=1,f=2,u=3}),
...
s(37397,72932,{b=1,c={6},f=7,lvl=30,u=2}),
s(37389,72921,{b=1,c={6},f=7,lvl=30,u=2}),
s(37391,72923,{b=1,c={6},f=7,lvl=30,u=2}),
s(37399,72934,{b=1,c={6},f=7,lvl=30,u=2}),
...
s(37386,72918,{b=1,c={6},f=7,lvl=30,u=2}),
s(37394,72929,{b=1,c={6},f=7,lvl=30,u=2}),
s(37401,72936,{b=1,c={6},f=7,lvl=30,u=2}),
s(37393,72925,{b=1,c={6},f=7,lvl=30,u=2}),
s(37388,72920,{b=1,c={6},f=7,lvl=30,u=2}),
s(37396,72931,{b=1,c={6},f=7,lvl=30,u=2}),
s(37392,72924,{b=1,c={6},f=7,lvl=30,u=2}),
s(37400,72935,{b=1,c={6},f=7,lvl=30,u=2}),
s(37398,72933,{b=1,c={6},f=7,lvl=30,u=2}),
s(37390,72922,{b=1,c={6},f=7,lvl=30,u=2}),
s(37395,72930,{b=1,c={6},f=7,lvl=30,u=2}),
s(37387,72919,{b=1,c={6},f=7,lvl=30,u=2}),
...
s(37264,72692,{b=1,c={11},f=5,lvl=30,u=2}),
s(37248,72675,{b=1,c={11},f=5,lvl=30,u=2}),
s(37256,72684,{b=1,c={11},f=5,lvl=30,u=2}),
s(37250,72677,{b=1,c={11},f=5,lvl=30,u=2}),
s(37258,72686,{b=1,c={11},f=5,lvl=30,u=2}),
s(37266,72694,{b=1,c={11},f=5,lvl=30,u=2}),
...
s(37253,72681,{b=1,c={11},f=5,lvl=30,u=2}),
s(37261,72689,{b=1,c={11},f=5,lvl=30,u=2}),
s(37245,72672,{b=1,c={11},f=5,lvl=30,u=2}),
s(37260,72688,{b=1,c={11},f=5,lvl=30,u=2}),
s(37268,72696,{b=1,c={11},f=5,lvl=30,u=2}),
s(37252,72679,{b=1,c={11},f=5,lvl=30,u=2}),
s(37255,72683,{b=1,c={11},f=5,lvl=30,u=2}),
s(37263,72691,{b=1,c={11},f=5,lvl=30,u=2}),
s(37247,72674,{b=1,c={11},f=5,lvl=30,u=2}),
s(37267,72695,{b=1,c={11},f=5,lvl=30,u=2}),
s(37251,72678,{b=1,c={11},f=5,lvl=30,u=2}),
s(37259,72687,{b=1,c={11},f=5,lvl=30,u=2}),
s(37257,72685,{b=1,c={11},f=5,lvl=30,u=2}),
s(37265,72693,{b=1,c={11},f=5,lvl=30,u=2}),
s(37249,72676,{b=1,c={11},f=5,lvl=30,u=2}),
s(37254,72682,{b=1,c={11},f=5,lvl=30,u=2}),
s(37246,72673,{b=1,c={11},f=5,lvl=30,u=2}),
s(37262,72690,{b=1,c={11},f=5,lvl=30,u=2}),
...
s(37381,72913,{b=1,c={3},f=6,lvl=30,u=2}),
s(37383,72915,{b=1,c={3},f=6,lvl=30,u=2}),
i(73146,{b=1,c={3},f=51,lvl=30,u=2}),
s(37547,73314,{b=1,c={3},f=3,lvl=30,u=2}),
s(37378,72910,{b=1,c={3},f=6,lvl=30,u=2}),
s(37385,72917,{b=1,c={3},f=6,lvl=30,u=2}),
s(37380,72912,{b=1,c={3},f=6,lvl=30,u=2}),
s(37384,72916,{b=1,c={3},f=6,lvl=30,u=2}),
s(37382,72914,{b=1,c={3},f=6,lvl=30,u=2}),
s(37379,72911,{b=1,c={3},f=6,lvl=30,u=2}),
...
s(37199,72624,{b=1,c={8},f=4,lvl=30,u=2}),
s(37201,72626,{b=1,c={8},f=4,lvl=30,u=2}),
i(73105,{b=1,c={8},f=51,lvl=30,u=2}),
s(37556,73323,{b=1,c={8},f=3,lvl=30,u=2}),
s(37196,72621,{b=1,c={8},f=4,lvl=30,u=2}),
s(37203,72628,{b=1,c={8},f=4,lvl=30,u=2}),
s(37198,72623,{b=1,c={8},f=4,lvl=30,u=2}),
s(37202,72627,{b=1,c={8},f=4,lvl=30,u=2}),
s(37200,72625,{b=1,c={8},f=4,lvl=30,u=2}),
s(37197,72622,{b=1,c={8},f=4,lvl=30,u=2}),
...
s(45905,88626,{b=1,c={10},f=5,lvl=30}),
s(45896,88617,{b=1,c={10},f=5,lvl=30}),
s(45907,88628,{b=1,c={10},f=5,lvl=30}),
s(45898,88619,{b=1,c={10},f=5,lvl=30}),
...
s(45893,88614,{b=1,c={10},f=5,lvl=30}),
s(45902,88623,{b=1,c={10},f=5,lvl=30}),
s(45900,88621,{b=1,c={10},f=5,lvl=30}),
s(45909,88630,{b=1,c={10},f=5,lvl=30}),
s(45895,88616,{b=1,c={10},f=5,lvl=30}),
s(45904,88625,{b=1,c={10},f=5,lvl=30}),
s(45908,88629,{b=1,c={10},f=5,lvl=30}),
s(45899,88620,{b=1,c={10},f=5,lvl=30}),
s(45897,88618,{b=1,c={10},f=5,lvl=30}),
s(45906,88627,{b=1,c={10},f=5,lvl=30}),
s(45894,88615,{b=1,c={10},f=5,lvl=30}),
s(45903,88624,{b=1,c={10},f=5,lvl=30}),
...
s(37429,72966,{b=1,c={2},f=7,lvl=30,u=2}),
s(37437,72974,{b=1,c={2},f=7,lvl=30,u=2}),
s(37421,72958,{b=1,c={2},f=7,lvl=30,u=2}),
s(37423,72960,{b=1,c={2},f=7,lvl=30,u=2}),
s(37431,72968,{b=1,c={2},f=7,lvl=30,u=2}),
s(37439,72976,{b=1,c={2},f=7,lvl=30,u=2}),
...
s(37418,72955,{b=1,c={2},f=7,lvl=30,u=2}),
s(37434,72971,{b=1,c={2},f=7,lvl=30,u=2}),
s(37426,72963,{b=1,c={2},f=7,lvl=30,u=2}),
s(37433,72970,{b=1,c={2},f=7,lvl=30,u=2}),
s(37441,72978,{b=1,c={2},f=7,lvl=30,u=2}),
s(37425,72962,{b=1,c={2},f=7,lvl=30,u=2}),
s(37420,72957,{b=1,c={2},f=7,lvl=30,u=2}),
s(37436,72973,{b=1,c={2},f=7,lvl=30,u=2}),
s(37428,72965,{b=1,c={2},f=7,lvl=30,u=2}),
s(37440,72977,{b=1,c={2},f=7,lvl=30,u=2}),
s(37424,72961,{b=1,c={2},f=7,lvl=30,u=2}),
s(37432,72969,{b=1,c={2},f=7,lvl=30,u=2}),
s(37438,72975,{b=1,c={2},f=7,lvl=30,u=2}),
s(37430,72967,{b=1,c={2},f=7,lvl=30,u=2}),
s(37422,72959,{b=1,c={2},f=7,lvl=30,u=2}),
s(37435,72972,{b=1,c={2},f=7,lvl=30,u=2}),
s(37427,72964,{b=1,c={2},f=7,lvl=30,u=2}),
s(37419,72956,{b=1,c={2},f=7,lvl=30,u=2}),
...
s(37223,72648,{b=1,c={5},f=4,lvl=30,u=2}),
s(37231,72657,{b=1,c={5},f=4,lvl=30,u=2}),
s(37226,72651,{b=1,c={5},f=4,lvl=30,u=2}),
s(37234,72660,{b=1,c={5},f=4,lvl=30,u=2}),
...
s(37225,72650,{b=1,c={5},f=4,lvl=30,u=2}),
s(37233,72659,{b=1,c={5},f=4,lvl=30,u=2}),
s(37228,72653,{b=1,c={5},f=4,lvl=30,u=2}),
s(37236,72662,{b=1,c={5},f=4,lvl=30,u=2}),
s(37222,72647,{b=1,c={5},f=4,lvl=30,u=2}),
s(37230,72656,{b=1,c={5},f=4,lvl=30,u=2}),
s(37235,72661,{b=1,c={5},f=4,lvl=30,u=2}),
s(37227,72652,{b=1,c={5},f=4,lvl=30,u=2}),
s(37232,72658,{b=1,c={5},f=4,lvl=30,u=2}),
s(37224,72649,{b=1,c={5},f=4,lvl=30,u=2}),
s(37221,72646,{b=1,c={5},f=4,lvl=30,u=2}),
s(37229,72655,{b=1,c={5},f=4,lvl=30,u=2}),
...
s(37240,72667,{b=1,c={4},f=5,lvl=30,u=2}),
s(37242,72669,{b=1,c={4},f=5,lvl=30,u=2}),
i(73125,{b=1,c={4},f=51,lvl=30,u=2}),
s(37553,73320,{b=1,c={4},f=3,lvl=30,u=2}),
s(37237,72664,{b=1,c={4},f=5,lvl=30,u=2}),
s(37244,72671,{b=1,c={4},f=5,lvl=30,u=2}),
s(37239,72666,{b=1,c={4},f=5,lvl=30,u=2}),
s(37243,72670,{b=1,c={4},f=5,lvl=30,u=2}),
s(37241,72668,{b=1,c={4},f=5,lvl=30,u=2}),
s(37238,72665,{b=1,c={4},f=5,lvl=30,u=2}),
...
s(37365,72892,{b=1,c={7},f=6,lvl=30,u=2}),
s(37373,72905,{b=1,c={7},f=6,lvl=30,u=2}),
s(37273,72701,{b=1,c={7},f=6,lvl=30,u=2}),
s(37367,72894,{b=1,c={7},f=6,lvl=30,u=2}),
s(37275,72703,{b=1,c={7},f=6,lvl=30,u=2}),
s(37375,72907,{b=1,c={7},f=6,lvl=30,u=2}),
...
s(37270,72698,{b=1,c={7},f=6,lvl=30,u=2}),
s(37362,72889,{b=1,c={7},f=6,lvl=30,u=2}),
s(37370,72902,{b=1,c={7},f=6,lvl=30,u=2}),
s(37369,72896,{b=1,c={7},f=6,lvl=30,u=2}),
s(37277,72705,{b=1,c={7},f=6,lvl=30,u=2}),
s(37377,72909,{b=1,c={7},f=6,lvl=30,u=2}),
s(37272,72700,{b=1,c={7},f=6,lvl=30,u=2}),
s(37364,72891,{b=1,c={7},f=6,lvl=30,u=2}),
s(37372,72904,{b=1,c={7},f=6,lvl=30,u=2}),
s(37368,72895,{b=1,c={7},f=6,lvl=30,u=2}),
s(37376,72908,{b=1,c={7},f=6,lvl=30,u=2}),
s(37276,72704,{b=1,c={7},f=6,lvl=30,u=2}),
s(37374,72906,{b=1,c={7},f=6,lvl=30,u=2}),
s(37274,72702,{b=1,c={7},f=6,lvl=30,u=2}),
s(37366,72893,{b=1,c={7},f=6,lvl=30,u=2}),
s(37363,72890,{b=1,c={7},f=6,lvl=30,u=2}),
s(37271,72699,{b=1,c={7},f=6,lvl=30,u=2}),
s(37371,72903,{b=1,c={7},f=6,lvl=30,u=2}),
...
s(37215,72640,{b=1,c={9},f=4,lvl=30,u=2}),
s(37218,72643,{b=1,c={9},f=4,lvl=30,u=2}),
i(73110,{b=1,c={9},f=51,lvl=30,u=2}),
s(37557,73324,{b=1,c={9},f=3,lvl=30,u=2}),
s(37217,72642,{b=1,c={9},f=4,lvl=30,u=2}),
s(37220,72645,{b=1,c={9},f=4,lvl=30,u=2}),
s(37214,72639,{b=1,c={9},f=4,lvl=30,u=2}),
s(37219,72644,{b=1,c={9},f=4,lvl=30,u=2}),
s(37216,72641,{b=1,c={9},f=4,lvl=30,u=2}),
s(37213,72638,{b=1,c={9},f=4,lvl=30,u=2}),
...
s(37405,72940,{b=1,c={1},f=7,lvl=30,u=2}),
s(37413,72948,{b=1,c={1},f=7,lvl=30,u=2}),
s(37415,72950,{b=1,c={1},f=7,lvl=30,u=2}),
s(37407,72942,{b=1,c={1},f=7,lvl=30,u=2}),
...
s(37410,72945,{b=1,c={1},f=7,lvl=30,u=2}),
s(37402,72937,{b=1,c={1},f=7,lvl=30,u=2}),
s(37409,72944,{b=1,c={1},f=7,lvl=30,u=2}),
s(37417,72952,{b=1,c={1},f=7,lvl=30,u=2}),
s(37412,72947,{b=1,c={1},f=7,lvl=30,u=2}),
s(37404,72939,{b=1,c={1},f=7,lvl=30,u=2}),
s(37416,72951,{b=1,c={1},f=7,lvl=30,u=2}),
s(37408,72943,{b=1,c={1},f=7,lvl=30,u=2}),
s(37406,72941,{b=1,c={1},f=7,lvl=30,u=2}),
s(37414,72949,{b=1,c={1},f=7,lvl=30,u=2}),
s(37403,72938,{b=1,c={1},f=7,lvl=30,u=2}),
s(37411,72946,{b=1,c={1},f=7,lvl=30,u=2}),
...
s(18280,38160,{cost={{"i",38186,1000}},f=2,u=10}),
s(18282,38162,{cost={{"i",38186,250}},f=2,u=10}),
s(18281,38161,{cost={{"i",38186,250}},f=2,u=10}),
s(18283,38163,{cost={{"i",38186,100}},f=2,u=10}),
